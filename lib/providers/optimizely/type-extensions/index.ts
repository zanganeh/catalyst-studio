...
import { PlatformExtension } from '../../universal/types/extensions';
import { PrimitiveType } from '../../universal/types/primitives';
import { CommonPattern, CollectionPattern } from '../../universal/types/common-patterns';
...
const contentAreaExtension: PlatformExtension = {
  ...
  extendsType: {
    ...
    itemType: { type: PrimitiveType.JSON } as any,
