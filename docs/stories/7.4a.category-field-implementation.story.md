...
- [ ] Update schema.prisma to add category field with default 'page'
- [ ] Modify existing migration file to include category column
- [ ] Run `npx prisma migrate reset` to reset database
- [ ] Update seed script to include category for test data
- [ ] Update createContentTypeService to require category parameter
- [ ] Remove determineCategory() method from database-type-loader.ts
- [ ] Update all type loaders to use explicit category from database
- [ ] Update TypeScript interfaces to include category
- [ ] Update validation rules for category-specific logic
- [ ] Update AI prompts and CLAUDE.md with category requirement
- [ ] Add category selector to UI creation form
- [ ] Update import/export to handle category field
...
_To be filled during implementation - expecting ~20+ files_
...
**Story Status**: Draft  
**Ready for Development**: No - Needs review and approval