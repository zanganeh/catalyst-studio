...
- [ ] Submit PR (REQUIRED FINAL TASK)
  - [ ] Push branch: `git push -u premium story/9.2-global-components`
  - [ ] Create PR from story branch → epic/epic-9-sitemap-builder branch
  - [ ] PR Title: "feat(9.2): implement global components for sitemap builder"
  - [ ] Link PR to story in description
  - [ ] Include screenshots of rendered components in PR
